...
> **Note (2026-06):** Triggers 2 and 3 (`ready-for-review` label, `/fs-review`
> slash command) dispatch only when the issue has an associated pull request
> (`issue.pull_request` present). Standalone issues no longer enqueue review.
