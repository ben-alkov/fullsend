...
- **[docs/problems/](docs/problems/)** — Deep dives into each major problem domain, each evolving independently:
  ...
  - [Vendor Priority Intake](docs/problems/vendor-priority-intake.md) — How downstream vendors express business priorities and how competing sources of strategic intent get reconciled
